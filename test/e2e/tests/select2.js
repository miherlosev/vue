...
test('select2', async t => {
    await t.expect(select2Page.select2.fallbackSelect.exists).ok()
    ...
    await t.click(select2Page.select2.container.dropdown)
    ...
    await t.click(select2Page.select2.container.options.nth(1))
    ...
    await t.click(select2Page.select2.container.options.nth(3))
    ...
    await t.expect(select2Page.selected.textContent).eql('Selected: 2')
